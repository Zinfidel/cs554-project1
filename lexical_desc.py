from scanner import BuildExpression
...
class LexicalDesc:
    ...
    def __init__(self, name, alphabet, classes):
        ...
        :param alphabet A list of backquoted symbols as produced by scanner.py.
        :param classes: A list of parsed classes. Each class is a list of tokens as produced by scanner.py.
        """
        self.name = name
